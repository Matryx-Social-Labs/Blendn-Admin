...
// The fourth sweeper. #265 added it to `initSocketServer` while #276 was
// moving the other three out; neither branch could see the other's half, so
// folding it in here is the merge doing what this file exists for.
import {
