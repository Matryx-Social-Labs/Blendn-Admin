...
| Reject a brand claim | admin claims queue | row, reviewer, note and audit written; the reason the form says "is sent to the claimant" reached nobody, on all three claim kinds (**SCRUM-117**, fixed: emailed via `lib/claim-decision-notify`) |
